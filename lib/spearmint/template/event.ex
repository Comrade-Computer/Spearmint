...
defmodule Spearmint.Template.Event do
  @moduledoc """
  ...
  - `Spearmint.Template.Event.Timer` - an event template that is used to create timer events

  ## Options

  See `Spearmint.Event` for the list of options.

  ## Examples

    ```elixir
      defmodule Demo.Events.ConsumerResource do
        use Spearmint.Template.Event, fields: [:amount]
      end
    ...
    quote bind_quoted: [opts: opts], location: :keep do
      ...
      defmacro __using__(opts) do
        quote bind_quoted: [
          ...
          use Spearmint.Event, fields: fields
        end
      end
    end
  end
