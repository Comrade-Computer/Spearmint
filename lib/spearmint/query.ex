...
defmodule Spearmint.Query do
  @moduledoc """
  The `Spearmint.Query` module provides a set of functions for querying entities, components and resources.

  The queries are read-only operations they do not modify the state of the components or resources.

  Queries can be run both from within the Spearmint systems and from outside of the framework.
  """
  ...
  @type t :: %Query{
          ...
          for_entities: list(Spearmint.Entity.t()),
          not_for_entities: list(Spearmint.Entity.t()),
          for_children_of: list(Spearmint.Entity.t()),
          for_descendants_of: list(Spearmint.Entity.t()),
          for_parents_of: list(Spearmint.Entity.t()),
          for_ancestors_of: list(Spearmint.Entity.t())
        }
  ...
  On its own, it will return an `Spearmint.Query` struct that holds the query details.
  The struct needs to be passed to `Spearmint.Query.stream/1` or `Spearmint.Query.one/1` to get the results.
  ...
  The entity can be queried as well by adding `Spearmint.Entity` as the first element in the tuple.
  ...
  - `:for` - a list of `t:Spearmint.Entity.t/0` that the query should be run for. The components will be returned only for those entities.
  - `:not_for` - a list of `t:Spearmint.Entity.t/0` that the query should not be run for. The components will be returned for all entities except those.
  - `:for_children_of` - a list of `t:Spearmint.Entity.t/0`. The components will be returned only for the children of those entities.
  - `:for_descendants_of` - a list of `t:Spearmint.Entity.t/0`. The components will be returned only for all descendants of those entities.
  - `:for_parents_of` - a list of `t:Spearmint.Entity.t/0`. The components will be returned only for the parents of those entities.
  - `:for_ancestors_of` - a list of `t:Spearmint.Entity.t/0`. The components will be returned only for all ancestors of those entities.
  ...
  ## Examples
    ```elixir
    Spearmint.Query.select({Spearmint.Entity, Demo.Components.Health, opt: Demo.Components.Mana},
  ...
  @doc """
  Fetches an `t:Spearmint.Entity.t/0` by its ID.
  ...
  ## Examples
    ...
    ```elixir
    {:ok, %Spearmint.Entity{}} = Spearmint.Query.fetch_entity(hero_entity_id)
    ```
  """
  @doc group: :entities
  @spec fetch_entity(Spearmint.Entity.id()) :: {:ok, Spearmint.Entity.t()} | {:error, :not_found}
  def fetch_entity(entity_id) when is_binary(entity_id) do
    ...
    case result do
      {[^entity_id], _continuation} ->
        {:ok, Spearmint.Util.build_entity(entity_id)}
  ...
  """
  @doc group: :entities
  @spec entity_exists?(Spearmint.Entity.id() | Spearmint.Entity.t()) :: boolean()
  def entity_exists?(entity_id) when is_binary(entity_id) do
    case fetch_entity(entity_id) do
      {:ok, %Spearmint.Entity{}} -> true
      _else -> false
    end
  end

  def entity_exists?(%Spearmint.Entity{id: entity_id}) do
  ...
  ## Examples
    ...
    ```elixir
    {:ok, %Spearmint.Entity{}} = Spearmint.Query.get_component_entity(hero_component)
    ```
  """
  @doc group: :entities
  ...
  ## Examples
    ...
    ```elixir
    [sword_item_entity, magic_potion_entity] = Spearmint.Query.list_children(hero_entity)
    ```
  """
  @doc group: :relationships
  @spec list_children(Spearmint.Entity.t()) :: list(Spearmint.Entity.t())
  ...
  ## Examples
    ...
    ```elixir
    [inventory_entity, map_entity] = Spearmint.Query.list_descendants(hero_entity)
    ```
  """
  @doc group: :relationships
  @spec list_descendants(Spearmint.Entity.t()) :: list(Spearmint.Entity.t())
  ...
  ## Examples
    ...
    ```elixir
    [hero_entity] = Spearmint.Query.list_parents(inventory_entity)
    ```
  """
  @doc group: :relationships
  @spec list_parents(Spearmint.Entity.t()) :: list(Spearmint.Entity.t())
  ...
  ## Examples
    ...
    ```elixir
    [hero_entity, level_entity] = Spearmint.Query.list_ancestors(compass_entity)
    ```
  """
  @doc group: :relationships
  ...
  ## Examples
    ...
    {:ok, %Demo.Components.Paladin{} = hero_class_component} =
      Spearmint.Query.fetch_tagged_component(hero_entity, [:class])
    ```
  """
  @doc group: :tags
  @spec fetch_tagged_component(Spearmint.Entity.t(), list(tag :: atom())) ::
  ...
  ## Examples
    ...
    ```elixir
    [:resource, :available] = Spearmint.Query.list_tags(gold_component)
    ```
  """
  @doc group: :tags
  ...
  ## Examples
    ...
    ```elixir
    [gold_component, gems_component] = Spearmint.Query.list_tagged_components([:resource, :available])
    ```
  """
  @doc group: :tags
  ...
  def list_tagged_components(tags) do
    ...
    filtered_entities_components_tags =
      case tags do
        [^timer_component_tag] ->
          Spearmint.Util.filter_timer_entities_components_tags()

        _else ->
          Spearmint.Util.filter_entities_components_tags(tags)
      end
  ...
  ## Examples
    ...
    ```elixir
    [gold_component, gems_component] = Spearmint.Query.list_tagged_components_for_entity(hero_entity, [:resource, :available])
    ```
  """
  @doc group: :tags
  @spec list_tagged_components_for_entity(Spearmint.Entity.t(), list(tag :: atom())) ::
          list(components_state :: struct())
  def list_tagged_components_for_entity(entity, tags) do
    ...
    entity
    |> Spearmint.Util.list_entities_tags_state()
  ...
  ## Examples
    ...
    ```elixir
    [gold_component, gems_component, gems_component] = Spearmint.Query.list_tagged_components_for_entities([hero_entity, enemy_entity], [:resource, :available])
    ```
  """
  @doc group: :tags
  @spec list_tagged_components_for_entities(list(Spearmint.Entity.t()), list(tag :: atom())) ::
          list(components_state :: struct())
  def list_tagged_components_for_entities(entities, tags) do
    ...
    tags
    |> Spearmint.Util.filter_entities_components_tags()
  ...
  ## Examples
    ...
    ```elixir
    [boots_component, compass_component] = Spearmint.Query.list_tagged_components_for_children(hero_entity, [:inventory])
    ```
  """
  @doc group: :tags
  @spec list_tagged_components_for_children(Spearmint.Entity.t(), list(tag :: atom())) ::
          list(components_state :: struct())
  ...
  ## Examples
    ...
    ```elixir
    [orc_component, orc_component, wizard_component] = Spearmint.Query.list_tagged_components_for_descendants(dungeon_entity, [:enemy])
    ```
  """
  @doc group: :tags
  @spec list_tagged_components_for_descendants(Spearmint.Entity.t(), list(tag :: atom())) ::
          list(components_state :: struct())
  ...
  ## Examples
    ...
    ```elixir
    [hero_component] = Spearmint.Query.list_tagged_components_for_parents(boots_entity, [:hero])
    ```
  """
  @doc group: :tags
  @spec list_tagged_components_for_parents(Spearmint.Entity.t(), list(tag :: atom())) ::
          list(components_state :: struct())
  ...
  ## Examples
    ...
    ```elixir
    [dungeon_component] = Spearmint.Query.list_tagged_components_for_ancestors(hero_entity, [:dungeon])
    ```
  """
  @doc group: :tags
  @spec list_tagged_components_for_ancestors(Spearmint.Entity.t(), list(tag :: atom())) ::
          list(components_state :: struct())
  ...
  ## Examples
    ...
    ```elixir
    {:ok, gold_component} = Spearmint.Query.fetch_component(hero_entity, Demo.Components.Gold)
    ```
  """
  ...
  ## Examples
    ...
    ```elixir
    {:ok, {gold_component, gems_component}} = Spearmint.Query.fetch_components(hero_entity, {Demo.Components.Gold, Demo.Components.Gems})
    ```
  """
  @doc group: :components
  @spec fetch_components(Spearmint.Entity.t(), component_modules :: tuple()) ::
  ...
  > #### Note  {: .info}
  >
  > The `Spearmint.Component.Children` and `Spearmint.Component.Parents`
  ...
  ## Examples
    ...
    [gold_component, gems_component, position_component, energy_component] =
      Spearmint.Query.list_components(hero_entity)
    ```
  """
  @doc group: :components
  @spec list_components(Spearmint.Entity.t()) :: list(components_state :: struct())
    ...
    f =
      Ex2ms.fun do
        ...
        when entity_id == ^id and
               component_module != Spearmint.Component.Children and
               component_module != Spearmint.Component.Parents ->
          component_state
      end
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.has_component?(hero_entity, Demo.Components.Gold)
    ```
  """
  @doc group: :components
  @spec has_component?(Spearmint.Entity.t(), module()) :: boolean()
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.has_components?(hero_entity, [Demo.Components.Gold, Demo.Components.Gems])
    ```
  """
  @doc group: :components
  @spec has_components?(Spearmint.Entity.t(), list(module())) :: boolean()
  def has_components?(entity, component_module_list) when is_list(component_module_list) do
    entities_components = Spearmint.Util.list_entities_components()
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.child_of?(parent: hero_entity, child: boots_entity)
    ```
  """
  @doc group: :relationships
  @spec child_of?(parent: Spearmint.Entity.t(), child: Spearmint.Entity.t()) :: boolean()
  def child_of?(parent: %Entity{} = parent, child: %Entity{} = child) do
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.parent_of?(parent: hero_entity, child: boots_entity)
    ```
  """
  @doc group: :relationships
  @spec parent_of?(parent: Spearmint.Entity.t(), child: Spearmint.Entity.t()) :: boolean()
  def parent_of?(parent: %Entity{} = parent, child: %Entity{} = child) do
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.has_children_with_component?(hero_entity, Demo.Components.Boots)
    ```
  """
  @doc group: :relationships
  @spec has_children_with_component?(Spearmint.Entity.t(), module()) :: boolean()
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.has_children_with_components?(hero_entity, [Demo.Components.Boots, Demo.Components.Sword])
    ```
  """
  @doc group: :relationships
  @spec has_children_with_components?(Spearmint.Entity.t(), list(module())) :: boolean()
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.has_parents_with_component?(boots_entity, Demo.Components.Hero)
    ```
  """
  @doc group: :relationships
  @spec has_parents_with_component?(Spearmint.Entity.t(), module()) ::
          boolean()
  ...
  ## Examples
    ...
    ```elixir
    true = Spearmint.Query.has_parents_with_components?(boots_entity, [Demo.Components.Hero, Demo.Components.Gold])
    ```
  """
  @doc group: :relationships
  @spec has_parents_with_components?(Spearmint.Entity.t(), list(module())) :: boolean()
  ...
  ## Examples
    ...
    ```elixir
    {:ok, lobby_resource} = Spearmint.Query.fetch_resource(Demo.Resources.Lobby)
    ```
  """
  @doc group: :resources
  ...
  defp filter_for_entities([]) do
    Stream.map(Spearmint.Util.list_entities_components(), fn {k, v} -> {k, v} end)
  end

  defp filter_for_entities(entities) do
    entity_ids = Enum.map(entities, & &1.id)

    Stream.filter(Spearmint.Util.list_entities_components(), fn {entity_id, _component_modules} ->
      entity_id in entity_ids
    end)
  end
  ...
  defp filter_not_for_entities(entities) do
    ...
    Stream.reject(Spearmint.Util.list_entities_components(), fn {entity_id, _component_modules} ->
      entity_id in entity_ids
    end)
  end
  ...
  defp validate_entities(entities) do
    ...
    case non_entities do
      ...
      _else ->
        raise Error,
              "Expected to be `Spearmint.Entity.t()` types, got: `#{Kernel.inspect(non_entities)}`"
    end
  end
