...
defmodule Spearmint.Entity do
  ...
  ## Examples
    ```elixir
    %Spearmint.Entity{id: "cfa1ad89-44b6-4d1f-8590-186354be9158"}
    ```
  """
  ...
  - `:components` - a list of `t:Spearmint.Component.component_spec/0` to be added to the entity.
  - `:children` A list of `t:Spearmint.Entity.t/0` to be added as children to the entity. Children entities should already exist.
  - `:parents` A list of `t:Spearmint.Entity.t/0` to be added as parents to the entity. Parent entities should already exist.
  ...
  # TODO this will need to look at the core pid object to find the correct info
  @spec fetch(Spearmint.Entity.id()) :: {:ok, t()} | {:error, :not_found}
  # coveralls-ignore-next-line
  defdelegate fetch(id), to: Spearmint.Query, as: :fetch_entity
end
